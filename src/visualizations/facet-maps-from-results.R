...
filenames <- filenames[grepl("modByCovarGrp", filenames)]
...
for(i in 1:length(v_var)){
  ...
  ggsave(paste0("./gen/visualizations/facet-maps-cv/map-",myoutcome,"-prev.png"), p1, width = 10, height = 5.5)
  ...
  ggsave(paste0("./gen/visualizations/facet-maps-cv/map-",myoutcome,"-var.png"), p2, width = 10, height = 5.5)
