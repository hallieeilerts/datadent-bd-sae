...
naive <- dhs %>% 
  ...
  summarise(nt_wm_micro_iron = mean(nt_wm_micro_iron, na.rm = TRUE),
            ...
            rh_anc_toxinj = mean(rh_anc_toxinj, na.rm = TRUE),
            rh_anc_neotet = mean(rh_anc_neotet, na.rm = TRUE),
...
naive_var <- dhs %>% 
  ...
  summarise(nt_wm_micro_iron = var(nt_wm_micro_iron, na.rm = TRUE),
            ...
            rh_anc_toxinj = var(rh_anc_toxinj, na.rm = TRUE),
            rh_anc_neotet = var(rh_anc_neotet, na.rm = TRUE),
...
dir <- dhs_svy %>% 
  ...
  summarise(nt_wm_micro_iron = survey_mean(nt_wm_micro_iron, na.rm = TRUE, vartype = "var"),
            ...
            rh_anc_toxinj = survey_mean(rh_anc_toxinj, na.rm = TRUE, vartype = "var"),
            rh_anc_neotet = survey_mean(rh_anc_neotet, na.rm = TRUE, vartype = "var"),
...
write.csv(est_fd, file = "./gen/calculate-direct/temp/direct-mother-focusdistricts.csv", row.names = FALSE)
